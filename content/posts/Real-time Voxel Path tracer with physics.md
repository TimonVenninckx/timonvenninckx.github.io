...
title = "Real-time Voxel Path tracer"
video = "/videos/Voxel-Path-Tracer.mp4"

projectDescription = "Project heavily inspired by hitgame 'Teardown', featuring a path tracer made in opengl compute shaders with a Wavefront approach, a custom sequential impulse physics solver and some voxel fracturing logic."
timeSpent = "8 weeks"
teamSize="Solo"
+++
